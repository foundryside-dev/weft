...
- `loom-design-system/README.md` — this file
- `loom-design-system/chats/` — conversation transcripts (read these!)
- `loom-design-system/project/` — the `Loom Design System` project files (HTML prototypes, assets, components)
