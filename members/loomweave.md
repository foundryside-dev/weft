...
- **Founding doctrine moved:** the federation doctrine/glossary that lived in `~/clarion/docs/suite/` are **promoted into this hub** ([doctrine.md](../doctrine.md), [glossary.md](../glossary.md)); Loomweave's copies are pointers.
