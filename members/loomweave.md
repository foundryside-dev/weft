...
**Current details:** v1.1.0-rc4; ~42 consult-mode MCP tools; CLI + MCP (stdio) + loopback HTTP read API. First-customer scale target: elspeth (~425k LOC). For the latest details, use `~/loomweave/Cargo.toml`, `~/loomweave/README.md`, and `~/loomweave/www/`.
