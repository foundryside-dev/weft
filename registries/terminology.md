...
|---|---|---|
| **member** | A product admitted to the Weft family. Current launch taxonomy separates **live core** (Loomweave, Filigree, Wardline, Legis) from **planned integration** (Charter) and design spikes (Warpline). | Don't call Shuttle or Lacuna a "member"; don't imply Charter gates the live-core launch until its adapters ship |
