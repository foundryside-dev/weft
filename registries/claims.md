...
|---|---|---|
| C-1 | The federation has 5 realized members: Loomweave, Filigree, Wardline, Legis, Charter | [doctrine.md](../doctrine.md) §1–2; repos at `~/{clarion,filigree,wardline,legis,charter}` |
...
| C-4 | Loomweave is the suite's identity authority; SEI is the binding key; locator is the address | [sei-standard.md](../sei-standard.md); Clarion ADR-038 |
...
| C-8 | Asterisk A-1 (Wardline→Filigree via Loomweave SARIF) is LIVE; A-2 (registry import) RETIRED 2026-06-05 | [asterisk-register.md](../asterisk-register.md); Clarion ADR-015 Rev 2, ADR-018 Rev 3 |
