...
export const MATRIX = [
  ...
  },
  {
    ...
    status: 'live',
    note: 'Drift-aware entity⇄issue binding shipped: filigree stores content_hash_at_attach; loomweave issues_for detects + reports drift, integration-tested. Asterisk until a two-real-daemon drift dogfood lands.',
  },
  {
    a: 'wardline',
    b: 'legis',
  ...
  },
  {
    ...
    status: 'live',
    note: 'Shipped: warpline resolves loomweave SEIs (entity_resolve) and keys its temporal surfaces on them, default-on at ingest. Asterisk until an automated live round-trip e2e gate lands.',
  },
  {
    a: 'warpline',
    b: 'wardline',
    ...
    status: 'partial',
    note: 'Enrichment shipped: warpline annotates the change-impact worklist with wardline trust findings (advisory). The risk-weighted re-ranking of the blast radius is not yet built.',
  },
  {
    a: 'warpline',
    b: 'legis',
