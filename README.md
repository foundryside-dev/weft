...
> **The federation is the product** ([PDR-0023](./pm/product/decisions/0023-federation-is-the-product-glue-is-the-value.md), 2026-06-15). Weft is **one product** — a shared-identity, agent-native code-intelligence federation — of which the five tools are components. The value is the **glue**: the SEI identity spine, the **seams** (the joins between members — these are the crown jewels), and the cross-cutting quality conventions, chief of them **provenance-honesty** (no result without its `cause + reason_class + fix` — the [`weft-reason` contract](./contracts/weft-reason-vocab.json), owner-blessed 2026-06-15). See [doctrine.md](./doctrine.md) (the PDR-0023 banner + honesty invariant).
